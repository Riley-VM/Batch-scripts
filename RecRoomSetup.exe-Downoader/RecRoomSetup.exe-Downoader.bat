...
title Downloading RecRoomSetup.exe & echo Downloading RecRoomSetup.exe & curl https://cdn.rec.net/static/Self_Distribute/RecRoomSetup.exe --output RecRoomSetup.exe
